...
'Enter a number between %(min)g and %(max)g': 'Digite um valor entre %(min)g e %(max)g',
'Enter a valid email address': 'Digite um e-mail válido.',
'Enter a value': 'Preencha este campo.',
'Enter an integer between %(min)g and %(max)g': 'Digite um valor entre %(min)g e %(max)g',
'Enter date and time as %(format)s': '',
'Enter date as %(format)s': 'Digite uma data no formato: %(format)s',
'Errors': 'Erros',
...
'Value not in database': 'Selecione um valor na lista',
